...
public class CustomerModel {
	...
	//@Pattern(regexp="[1-9][0-6]{9}", message="Mobile number is expected to be 10 digits and should not start with 0")
	//@NotEmpty(message="This field cannot be empty")
	...
	public CustomerModel(int customerid,
			@NotEmpty(message = "This field cannot be empty") @NotNull(message = "This field cannot be omitted") int aadharno,
			@NotEmpty(message = "This field cannot be empty") @NotNull(message = "This field cannot be omitted") String firstname,
			@NotEmpty(message = "This field cannot be empty") @NotNull(message = "This field cannot be omitted") String lastname,
			@Pattern(regexp = "[1-9][0-9]{9}", message = "Mobile number is expected to be 10 digits and should not start with 0") @NotEmpty(message = "This field cannot be empty") @NotNull(message = "Mobile number cannot be omitted") int mobileno) {
		super();
		this.customerid = customerid;
		this.aadharno = aadharno;
		this.firstname = firstname;

...
public class OfficeOutletRestController {
	...
	public ResponseEntity <String> removeOfficeAction(@PathVariable("officeid") int officeid, BindingResult result) throws OutletNotFoundException {
	...
	public ResponseEntity <List<CourierOfficeOutletModel>> getAllOfficesData(BindingResult result) throws OutletNotFoundException{
